...
(opengl32.dll, glu32.dll and glut32.dll on Windows) are properly installed
on your system.

You can find GLUT at http://www.opengl.org/resources/libraries/glut/
...
Primary CPAN OpenGL Owner/Maintainer: Bob Free - http://graphcomp.com/opengl
...
Copyright (c) 2007 Bob Free <bfree@graphcomp.com>. All rights reserved.
...
INFO: http://graphcomp.com/opengl
...
TARBALL: http://graphcomp.com/opengl/OpenGL-0.55.tar.gz

ZIP: http://graphcomp.com/opengl/OpenGL-0.55.zip
