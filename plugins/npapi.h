...
/* ws_info in the NPWindow in the NP_SetWindow() call */
typedef struct
{
    int32 type;
    Display* display;
    Visual* visual;		/* visual colormap and depth of the toplevel */
    Colormap colormap;		/* shell for which this window is a child.   */
    unsigned int depth;
